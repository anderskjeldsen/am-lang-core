...
function_result Am_Lang_Double_toUByte_0(double const this)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;
...
function_result Am_Lang_Double_toUShort_0(double const this)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;

	__result.return_value = (nullable_value) { .value = { .ushort_value = (unsigned short)this }, .flags = 0 };
__exit: ;
	return __result;
};

function_result Am_Lang_Double_toUInt_0(double const this)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;

	__result.return_value = (nullable_value) { .value = { .uint_value = (unsigned int)this }, .flags = 0 };
__exit: ;
	return __result;
};

function_result Am_Lang_Double_toULong_0(double const this)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;

	__result.return_value = (nullable_value) { .value = { .ulong_value = (unsigned long long)this }, .flags = 0 };
__exit: ;
	return __result;
};
...
function_result Am_Lang_Double_parse_0(aobject * const s)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;
	...
	__result.return_value = (nullable_value) { .value = { .double_value = result }, .flags = 0 };
