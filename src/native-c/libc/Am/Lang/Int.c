...
function_result Am_Lang_Int_toString_0(nullable_value const this)
{
	...
	aobject * str_obj = __allocate_object_with_extra_size(&Am_Lang_String, sizeof(string_holder) + 12);
	...
	int len = sprintf(new_str, "%d", this.value.int_value);
...
function_result Am_Lang_Int_toShort_0(int const this)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;
...
function_result Am_Lang_Int_toLong_0(int const this)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;
...
function_result Am_Lang_Int_parse_1(nullable_value const s)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;
	...
	__result.return_value = (nullable_value) { .value = { .int_value = (int)result }, .flags = 0 };
