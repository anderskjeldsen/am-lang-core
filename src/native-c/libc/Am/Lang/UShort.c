...
function_result Am_Lang_UShort_toFloat_0(unsigned short const this)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;
...
function_result Am_Lang_UShort_toDouble_0(unsigned short const this)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;
...
function_result Am_Lang_UShort_parse_0(aobject * const s)
{
	...
	__result.return_value = (nullable_value) { .value = { .ushort_value = (unsigned short)result }, .flags = 0 };
