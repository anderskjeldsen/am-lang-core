...
function_result Am_Lang_Short_toFloat_0(short const this)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;
...
function_result Am_Lang_Short_toDouble_0(short const this)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;
...
function_result Am_Lang_Short_parse_0(aobject * const s)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;
