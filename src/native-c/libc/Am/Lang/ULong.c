...
function_result Am_Lang_ULong_toFloat_0(unsigned long long const this)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;
...
function_result Am_Lang_ULong_toDouble_0(unsigned long long const this)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;
...
function_result Am_Lang_ULong_parse_0(aobject * const s)
{
	function_result __result = { .has_return_value = true };
	bool __returning = false;
